...
import { DEFAULT_MINT } from "../cashu";
...
const ESCROW_EXPLANATIONS = {
  cashu: {
    ...
    icon: <Shield size={22} />,
    howItWorks: [
      "You lock sats into a Cashu mint using a cryptographic spending condition",
      "The sats can ONLY be released if both you AND the body person sign — OR after 7 days the body person can claim alone",
      "Once the tattoo is done and proof is posted, you both co-sign to release instantly",
      "If you ghost after proof is posted, the body person auto-claims after 7 days",
      "No coordinator, no trust in anyone — just math",
    ],
