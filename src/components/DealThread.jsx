...
import { getEscrowInvoice, pollAndLockEscrow, redeemEscrowToken, getLocktimeDisplay } from "../cashu";
              ...
              {myRole === "seller" && (
                <div className="timelock-notice">
                  ...
                  <span>
                    ...
                    {funded?.locktimeTs > 0 && ` After ${getLocktimeDisplay(funded.locktimeTs)}, you can claim the Cashu tokens unilaterally.`}
                  </span>
                </div>
              )}
            </div>
