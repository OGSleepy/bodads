...
const STATUS_LABELS = {
  proposed:        { label: "Awaiting Acceptance", labelSeller: "Review Proposal", color: "#ffd700" },
  accepted:        { label: "Accepted — Fund Escrow", labelSeller: "Accepted — Awaiting Funding", color: "#00d4ff" },
  funded:          { label: "Funded", labelSeller: "Funded — Get the Tattoo!", color: "#39ff14" },
  proof_submitted: { label: "Proof Submitted — Release?", labelSeller: "Proof Submitted", color: "#ff6b35" },
  completed:       { label: "Completed ✓", labelSeller: "Completed ✓", color: "#39ff14" },
};
        ...
        <div className="deal-thread-left">
          ...
          <div className="deal-thread-info">
            ...
            <span className="deal-thread-meta">
              ...
              {" · "}<span style={{ color: statusInfo.color }}>{myRole === "seller" ? (statusInfo.labelSeller || statusInfo.label) : statusInfo.label}</span>
            </span>
          </div>
        </div>
